...
void CHornet :: Spawn( void )
{
	...
	if ( RANDOM_LONG ( 1, 5 ) <= 2 )
	{
		...
		// Oz variables (.value)
		m_flFlySpeed = speedhornet.value;
	}
	else
	{
		m_iHornetType = HORNET_TYPE_ORANGE;
		// Oz variables (.value)
		m_flFlySpeed = speedhornet2.value;
	}
...
*/
	...
	MESSAGE_BEGIN( MSG_BROADCAST, SVC_TEMPENTITY );
		...
		case HORNET_TYPE_RED:
			// Oz variables (.value)
			WRITE_BYTE( colorredhornet1.value );   // r, g, b
			WRITE_BYTE( colorgreenhornet1.value );   // r, g, b
			WRITE_BYTE( colorbluehornet1.value );   // r, g, b
			break;
		case HORNET_TYPE_ORANGE:
			// Oz variables (.value)
			WRITE_BYTE( colorredhornet2.value );   // r, g, b
			WRITE_BYTE( colorgreenhornet2.value );   // r, g, b
			WRITE_BYTE( colorbluehornet2.value );   // r, g, b
			break;
		}
